...
{
    ofstream outFile;
    outFile.open("./docs/outKnnFB.data", ios_base::app);
	...
	ANNbruteForce*		bruteforce;					// search structure
	...
	bruteforce = new ANNbruteForce(					// build search structure
    ...
    outFile << nPts << "\t" << duration.count() << endl;
